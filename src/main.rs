...
// Default terminal size is 80x50
struct Player {
    x: i32,
    y: f32,
    velocity: f32,
...
impl Player {
    ...
    fn render(&mut self, ctx: &mut BTerm) {
        ...
        ctx.set_fancy(
            ...
            WHITE,
            NAVY,
            DRAGON_FRAMES[self.dragon_frame],
        );
    ...
    fn gravity_and_move(&mut self) {
        ...
        self.dragon_frame += 1;
        self.dragon_frame = self.dragon_frame % DRAGON_FRAMES.len();
    }
...
impl Obstacle {
    ...
    fn render(&mut self, ctx: &mut BTerm, player_x: i32) {
        ...
        for x in 0..SCREEN_WIDTH {
            ctx.set(x, SCREEN_HEIGHT - 1, WHITE, NAVY, to_cp437('#'));
        }
        // render the top half
...
impl State {
    ...
    fn main_menu(&mut self, ctx: &mut BTerm) {
        ctx.cls();
        ctx.print_color_centered(5, SKY_BLUE, BLACK, "Welcome to Flappy Dragon");
        ctx.print_color_centered(8, LIGHT_GREEN, BLACK, "(P) Play Game");
        ctx.print_color_centered(10, LIGHT_PINK, BLACK, "(Q) Quit Game");
    ...
    fn dead(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(7, LIGHT_CYAN, BLACK, &format!("You earned {} points", self.score));
        ctx.print_color_centered(9, LIGHT_GREEN, BLACK, "(P) Play Game");
        ctx.print_color_centered(11, LIGHT_PINK, BLACK, "(Q) Quit Game");
